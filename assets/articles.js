...
const KENJI_ARTICLES = [
  ...
  { slug: 'in-person-sales', url: 'clanky/in-person-sales.html', icon: '🖼️', category: 'byznys',
    title: 'In-person sales — trojnásobek z jedné zakázky', desc: 'Prodej alb, tisků a upsellů, který zdvoj- až ztrojnásobí tržbu na klienta. Ekonomika, sezení, balíčky, Pixin.',
    status: 'published', date: '2026-08-24',
    tags: ['in-person sales','ips','alba','tisky','produkty','upsell','marže','pixin','prodej'] },
  { slug: 'firemni-klienti-retainery', url: 'clanky/firemni-klienti-retainery.html', icon: '🏢', category: 'byznys',
    title: 'Firemní klienti a retainery — příjem každý měsíc', desc: 'Jak ulovit firmu na měsíční paušál a postavit si stabilní příjem 15–40 tisíc. Outreach, pitch, model, nacenění, smlouva.',
    status: 'published', date: '2026-08-24',
    tags: ['retainer','firemní klienti','b2b','paušál','stabilní příjem','outreach','nabídka','smlouva'] },
